...
#python3 train_autoencoders.py --name_model Modelo_Kyoto --autoencoder_base Kyoto --autoencoder_epocas 200 
#python3 train_autoencoders.py --name_model Modelo_Kyoto --autoencoder_base CNR --autoencoder_epocas 50 
#python3 train_autoencoders.py --name_model Modelo_Kyoto --autoencoder_base PKLot --autoencoder_epocas 50 
